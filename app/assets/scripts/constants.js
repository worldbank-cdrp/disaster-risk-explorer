...
export const legends = {
  admin0: {
    LS_EQ:
    [ [ 351733.748, '#fde291' ],
      [ 11210615351.16, '#e6be79' ],
      [ 35231565706.4, '#cf9a62' ],
      [ 81842994610, '#b8774a' ],
      [ 135185544990, '#a15333' ],
      [ 237301299920, '#8b301c' ] ],
    LS_EQ_AAL:
      [ [ 882840.94, '#fde291' ],
        [ 179725542.9289, '#e6be79' ],
        [ 527610320.623406, '#cf9a62' ],
        [ 1297592230.8282502, '#b8774a' ],
        [ 2147951464.451703, '#a15333' ],
    ...
    LS_FL:
     [ [ 1558458, '#e0efda' ],
       ...
       [ 509755198, '#1d305b' ] ],
    LS_FL_AAL:
     [ [ 7497463.675551, '#e0efda' ],
       [ 29989854.702204, '#b9c8c0' ],
       [ 74455954.916855, '#92a2a7' ],
       [ 136342933.514531, '#6b7c8d' ],
       [ 375781981.0340609, '#445674' ],
       [ 420086655.465771, '#1d305b' ] ],
    LS_WS:
     [ [ 1909102, '#e0efda' ],
       [ 2063414124, '#bfd2c0' ],
       [ 5610680539, '#9eb5a7' ],
  ...
  admin1: {
    LS_EQ_AAL:
     [ [ 1950.5664000000002, '#fde291' ],
       [ 6317435.384015991, '#e6be79' ],
       [ 20942344.070599984, '#cf9a62' ],
       [ 41999629.08319992, '#b8774a' ],
       [ 75439284.54280002, '#a15333' ],
       [ 125255440.56730002, '#8b301c' ] ],
    LS_FL:
     [ [ 28859, '#e0efda' ],
       [ 9539755, '#b9c8c0' ],
       [ 24298022, '#92a2a7' ],
    ...
    LS_WS:
     [ [ 0.110604, '#e0efda' ],
       [ 53327461.49975797, '#bfd2c0' ],
       [ 162470640.04151404, '#9eb5a7' ],
       [ 297403995.764447, '#7d998d' ],
       [ 462105082.90579414, '#5c7c74' ],
       [ 798351795.7017964, '#3c605b' ] ],
    LS_WS_AAL:
     [ [ 1399.0569020000005, '#e0efda' ],
       [ 862825.0090050002, '#bfd2c0' ],
       [ 2067265.5015009998, '#9eb5a7' ],
       [ 4394840.799159001, '#7d998d' ],
       [ 6714980.464884992, '#5c7c74' ],
       [ 8706085.689194, '#3c605b' ] ],
    HZ_WS:
     [ [ 0.110604, '#e0efda' ],
       [ 53327461.49975797, '#bfd2c0' ],
       [ 162470640.04151404, '#9eb5a7' ],
