            ...
            <h2 className='results__title'>{adminName}</h2>
              <div className='results__container'>
                ...
                <dl className='stats'>
                  ...
                  <dd className='stat__value unimplemented'>$ {d.EX_GD === undefined ? ' -' : shortenNumber(d.EX_GD, 2, false)}</dd>
                  <dt className='stat__attribute'>{t('Building Stock Exposure')}</dt>
                  <dd className='stat__value unimplemented'>$ {d.EX_BS === undefined ? ' -' : shortenNumber(d.EX_BS, 2, false)}</dd>
                </dl>
