...
for province in countries/[A-Z][A-Z]-[A-Z0-9].geojson; do
...
for province in countries/[A-Z][A-Z]-[A-Z0-9][A-Z0-9].geojson; do
  echo province: ${province:t:r}
  echo country: ${${province:t:r}:0:2}
  echo ${province}
  ## agg-country.js takes 4 arguments, group boundary, data, output file, string to prepend variable names with
...
for province in countries/[A-Z][A-Z]-[A-Z0-9][A-Z0-9][A-Z0-9].geojson; do
  echo province: ${province:t:r}
  echo country: ${${province:t:r}:0:2}
  echo ${province}
  ## agg-country.js takes 4 arguments, group boundary, data, output file, string to prepend variable names with
